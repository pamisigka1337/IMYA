...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative bg-gradient-to-br from-secondary via-background to-accent/30 py-20 md:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
              Прокат брендовой одежды
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              ...
              <Link href="/catalog">
                <Button variant="outline" size="lg" data-testid="button-how-it-works">
                  Как это работает
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <Card className="text-center border-0 bg-secondary/30">
              <CardContent className="pt-8 pb-6">
                ...
                <h3 className="font-semibold mt-4">1. Выберите наряд</h3>
                <p className="text-sm text-muted-foreground mt-2">
                  Просмотрите каталог и найдите идеальный образ для вашего события
                </p>
              </CardContent>
            </Card>
            <Card className="text-center border-0 bg-secondary/30">
              <CardContent className="pt-8 pb-6">
                ...
                <h3 className="font-semibold mt-4">2. Забронируйте даты</h3>
                <p className="text-sm text-muted-foreground mt-2">
                  Выберите удобные даты аренды и оформите бронь онлайн
                </p>
              </CardContent>
            </Card>
            <Card className="text-center border-0 bg-secondary/30">
              <CardContent className="pt-8 pb-6">
                ...
                <h3 className="font-semibold mt-4">3. Заберите и верните</h3>
                <p className="text-sm text-muted-foreground mt-2">
                  Заберите наряд в пункте выдачи и верните после использования
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 text-center md:hidden">
            <Link href="/catalog">
              <Button variant="outline" data-testid="link-view-all-mobile">
                Все товары
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
